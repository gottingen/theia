...
#endif
#include <theia/glm/gtx/dual_quaternion.hpp>
#include <theia/glm/gtc/vec1.hpp>
#include <theia/glm/gtc/quaternion.hpp>
#include <theia/glm/ext/scalar_int_sized.hpp>
#include <theia/glm/ext/scalar_uint_sized.hpp>
