...
#include <theia/glm/gtc/epsilon.hpp>
#include <theia/glm/gtc/matrix_transform.hpp>
#include <theia/glm/gtc/type_ptr.hpp>
...
Widget::Widget(int pWidth, int pHeight, const char* pTitle,
    ...
    mWindow = SDL_CreateWindow(
        (pTitle != nullptr ? pTitle : "theia-Demo"), SDL_WINDOWPOS_UNDEFINED,
...
void Widget::setTitle(const char* pTitle) {
    SDL_SetWindowTitle(mWindow, (pTitle != nullptr ? pTitle : "theia-Demo"));
}
