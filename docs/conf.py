...
# -*- coding: utf-8 -*-
#
# theia documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'theia', 'theia Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'theia', 'theia Documentation',
     author, 'theia', 'One line description of project.',
     'Miscellaneous'),
]
