#
# Make a version file that includes the theia version and git revision
#
set(FG_VERSION_MAJOR ${theia_VERSION_MAJOR})
set(FG_VERSION_MINOR ${theia_VERSION_MINOR})
set(FG_VERSION_PATCH ${theia_VERSION_PATCH})
...
configure_file(
    ${PROJECT_SOURCE_DIR}/include/theia/fg/version.h.in
    ${PROJECT_BINARY_DIR}/include/theia/fg/version.h)

configure_file(
    ${PROJECT_SOURCE_DIR}/src/backend/common/version.hpp.in
